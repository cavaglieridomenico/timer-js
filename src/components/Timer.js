export default class Timer {
  constructor(root) {
    ...
    this.element.reset.addEventListener("click", () => {
      const inputMinutes = prompt("Enter number of minutes:", 1.5);
  ...
  updateInterfaceControls() {
    if (this.interval === null) {
      ...
      this.element.control.innerHTML = `<span class="material-icons">pause_arrow</span>`;
  ...
  static getHTML() {
    return ` 
      ...
      <button
        type="button"
        class="timer__btn timer__btn--control"
      >
      </button>
